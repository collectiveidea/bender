  ...
  describe "POST /api/v1/webhooks/optix" do
    describe "receiving a checkin" do
      it "creates a user if needed" do
        ...
        post "/api/v1/webhooks/optix", params: '{"check_in_datetime": "2022-03-23 16:12", "check_in_timestamp": "1648051960", "checkin_id": "216292", "created_datetime": "2022-03-23 16:12", "member_email": "member@example.com", "member_full_name": "Sam Body", "member_last_name": "Body", "member_name": "Sam", "venue_id": "24263", "venue_name": "BizCo HQ", "workspace_name": "BizCo"}'
    ...
    describe "receiving a new member" do
      it "creates a user if needed" do
        headers = { "CONTENT_TYPE" => "application/json" }
        post "/api/v1/webhooks/optix", params: '{"city": "", "email": "member@example.com", "first_name": "", "full_name": " ", "last_name": "", "member_id": "161128", "phone": "", "venue_id": "24263", "venue_name": "BizCo"}'
